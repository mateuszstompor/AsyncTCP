#
#  Be sure to run `pod spec lint AsyncTCP.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source_files  = "AsyncTCP/**/*.{h,m}"
  spec.exclude_files = "AsyncTCPTests/**/*.{h,m}"
  spec.osx.exclude_files = "AsyncTCP/iOS/*.h"
  spec.ios.exclude_files = "AsyncTCP/macOS/*.h"
